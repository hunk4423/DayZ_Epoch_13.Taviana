...
_role1names = ["DayZ Origins OverPoch"];
_role2 = "Версия мода";
_role2names = ["1.8/1.0.5.1"];
_role3 = "Server protected<br />by";				//The "by" in this row will be shown one row below "Server antihack". Can be applied to any role
_role3names = ["infiSTAR.de", "BattlEye", "Admins"];
_role4 = "Forum и правила сервера на:";
_role4names = ["http://ВАШ_ФОРУМ"];
_role5 = "Внимание игроков!";
_role5names = ["Незнание правил не<br />освобождает от ответственности!"];
_role6 = "За использование читов";
_role6names = ["вечный бан!"];
